...
Identify by mac: reads the peer's link-layer address, where the transport reports one; a transport-layer identifier whose claim is passed. A technology of
